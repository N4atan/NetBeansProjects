...
public class ConexaoSQLite {
	...
	public static void criarTabela(Connection conexao) {
		...
		String sql = "CREATE TABLE IF NOT EXISTS costs ("
				...
				+ "titulo VARCHAR(100) NOT NULL, " // Coluna 'nome' do tipo TEXT, obrigatório (NOT NULL)
				+ "descricao TEXT  UNIQUE NOT NULL," // Coluna 'email' do tipo TEXT, obrigatório (NOT NULL)
